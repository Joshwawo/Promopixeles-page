    ...
    <div className="rojito py-24">
      <div className=" container mx-auto">
        <div className=" ">
          ...
          <div className="">
            <p className=" text-center sm:text-left text-white md:w-2/3 ">
        ...
        <div className="cajita py-15 flex flex-col items-center md:flex-row md:justify-between text-white">
          <div className="md:py-20  py-10">
            ...
            <p className="py-7">Agenda Digital</p>
          </div>

          <div className="md:py-20  py-10">
            <img className="px-7" src={como2} alt="Icono uno" />
            <p className="py-7">Estrategia de datos</p>
          </div>
          <div className="md:py-20  py-10 ">
            <img className="px-7" src={como3} alt="Icono uno" />
            <p className="py-7">Impacto Financiero <br /> Positivo</p>
          </div>
          <div className="md:py-20  py-10">
            <img className="px-7" src={como4} alt="Icono uno" />
            <p className="py-7">Transformacion de <br /> datos</p>
          </div>
        </div>
      </div>
    </div>
